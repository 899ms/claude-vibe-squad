...
| **S2** Design (pipeline / IaC architecture) | `architect`, `devops-engineer`, `site-reliability-engineer` | `context7` | `dependency-cycle-audit` | `credential_change` (secrets design) |
| **S3** Produce (CI / IaC / rails) | `devops-engineer` | `context7` | — | — |
| **S4** Verify | `test-engineer`, `site-reliability-engineer` | — | — | — |
