...
- Either way: **report the reachable-known ones to the project as free remediation** (goodwill), and only SUBMIT the novel/incomplete-fix ones. Feed the decision to `impact-validator` (G3 dedup, G4 scope). Related: [[chain-construct]].
