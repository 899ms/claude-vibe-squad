...
class Validator:
    ...
    def validate_runtime(self) -> None:
        ...
        for raw_row in data:
            ...
            routes = {l for l in (primary_lane, backup_lane, escalate_lane, review_lane) if l != "none"}
            ...
            if backup_lane != "none" and primary_lane == backup_lane:
