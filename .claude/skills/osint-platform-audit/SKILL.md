...
audience: specialist
description: "Use when an authorized organization needs a passive, public-source inventory of its external footprint—correlate domains, certificates, repositories, registries, exposed cloud assets, and minimal ownership evidence with source, date, and confidence, then separate public-by-design from public-by-accident. Not for active probing, authentication with discovered credentials, or application testing."
---
