...
audience: specialist
description: Use when you are sitting on a pile of candidate findings and must cut it down to what is real, reachable, and worth reporting — run each through reproduce-from-clean, reachability, attacker-gain, precondition, and deduplicate-by-root-cause gates, then record which gate every dropped candidate failed.
---
