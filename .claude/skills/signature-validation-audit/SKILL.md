...
audience: specialist
description: "Use during an authorized EVM audit when signature verification may fall back from failed ECDSA recovery to ERC-1271 or may treat zero-code precompile addresses as EOAs—classify every auth entrypoint, then test zero-address fallback and 0x01–0x09 boundaries on a fork with negative controls and invariants. It excludes the malicious-verifier return-channel condition covered by erc1271-revert-data-check."
---
