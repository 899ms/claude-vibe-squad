...
- **`V1.1.8` is the current release version.** Git tags run `v1.1.0` through `v1.1.6`; `v1.1.7` and
  `v1.1.8` are tagged on `main` by Chrono as each release is cut; the next upgrade would be `V1.1.9`. This is the
