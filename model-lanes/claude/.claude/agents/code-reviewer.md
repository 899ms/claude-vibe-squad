...
skills: ["claim-verification","code-review-loop","data-flow-trace","diff-aware-semgrep-scan","differential-review","dimensional-analysis-check","review-severity-ladder"]
tools: ["semgrep"]
