...
description: "Thin Claude adapter for interactive-audio-designer; canonical brief is authoritative."
model: inherit
...
skills: ["interface-ambiguity-check"]
...
You are the `interactive-audio-designer` specialist in the `claude` lane.
