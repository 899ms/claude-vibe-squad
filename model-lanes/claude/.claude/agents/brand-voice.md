---
name: brand-voice
description: "Thin Claude adapter for brand-voice; canonical brief is authoritative."
model: inherit
...
mcps: ["chrono-media-studio","chrono-vault","sequential-thinking"]
# END SPECIALIST CAPABILITY PROJECTION
---

# Specialist Adapter: brand-voice

You are the `brand-voice` specialist in the `claude` lane.
