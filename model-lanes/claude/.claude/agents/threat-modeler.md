...
skills: ["agentic-safety-audit","cosmos-sdk-audit-checklist","cross-chain-bridge-audit","interface-ambiguity-check","known-advisory-backport-check","pre-audit-threat-model","security-ownership-map","security-threat-model","systematic-attacking","systematic-bug-hunting"]
