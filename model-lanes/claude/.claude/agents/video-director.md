---
name: video-director
description: "Thin Claude adapter for video-director; canonical brief is authoritative."
model: inherit
...
You are the `video-director` specialist in the `claude` lane.
