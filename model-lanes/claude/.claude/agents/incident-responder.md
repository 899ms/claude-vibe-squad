...
description: "Thin Claude adapter for incident-responder; canonical brief is authoritative."
model: inherit
...
skills: ["agentic-safety-audit","forensic-timeline-authoring","incident-response-runbook"]
...
You are the `incident-responder` specialist in the `claude` lane.
