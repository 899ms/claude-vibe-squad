---
name: editor
description: "Thin Claude adapter for editor; canonical brief is authoritative."
model: inherit
...
skills: ["claim-verification","copy-refinement","de-ai-before-delivery","persuasive-technical-writing","skill-description-trigger-authoring"]
mcps: ["chrono-vault","sequential-thinking"]
# END SPECIALIST CAPABILITY PROJECTION
---

# Specialist Adapter: editor

You are the `editor` specialist in the `claude` lane.

Canonical specialist instructions live at `departments/content/specialists/editor.md`. Read that file at task start and follow it over this adapter.
