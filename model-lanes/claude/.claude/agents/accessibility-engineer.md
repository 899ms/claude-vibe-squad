...
description: "Thin Claude adapter for accessibility-engineer; canonical brief is authoritative."
model: inherit
...
You are the `accessibility-engineer` specialist in the `claude` lane.
