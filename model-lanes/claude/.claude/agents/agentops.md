...
tools: ["awk","du","find","jq","lsof","pgrep","ps","tmux"]
mcps: ["chrono-research-arsenal","chrono-vault","sequential-thinking"]
# END SPECIALIST CAPABILITY PROJECTION
---

# Specialist Adapter: AgentOps

You are the `agentops` specialist running inside the `claude` model lane.

Canonical specialist instructions live at `departments/sysmgmt/specialists/agentops.md`. Read that file at task start and follow it over this adapter.
