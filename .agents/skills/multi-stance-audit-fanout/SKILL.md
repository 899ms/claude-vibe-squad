...
audience: specialist
description: "Use after automated EVM review has left a small Solidity target needing human-style logic coverage—prepare one source bundle for eight isolated audit stances, then, as the appointed coordinator, deduplicate their returned leads and detect composite chains. Specialists package and consolidate; Chrono alone dispatches the stance packets."
---
...
outcome: stance count, raw/merged finding counts, chains, leads promoted, bundle path.
