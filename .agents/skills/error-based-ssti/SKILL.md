...
audience: specialist
description: "Use during an operator-authorized web assessment when a suspected backend template or expression sink is blind or suppresses output: force reflected evaluation exceptions or build an HTTP-status oracle to demonstrate scoped code execution or data extraction with a benign control."
---
