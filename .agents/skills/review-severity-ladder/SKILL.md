...
audience: specialist
description: Use when you need severity to mean the same thing across reviewers, specialists, and models — place each finding on one shared critical/high/medium/low/note rung by consequence rather than fix effort, keep severity separate from confidence, and declare the deliverable's reporting floor.
---
